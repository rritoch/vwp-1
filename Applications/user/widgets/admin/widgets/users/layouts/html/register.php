...
<table id="userinfo" class="control_panel">
 <thead>
  <tr class="controls">
   <td colspan="5">
    <ul>
     ...
     <li><a href="#userinfo_go1"><span><input type="radio" name="task" value="register_user" /> Save</span></a></li>
     <li><a href="#userinfo_go1"><span><input type="radio" name="task" value="new_user_reset" /> Reset</span></a></li>
  ...
  <tr class="title">
   ...
   <td colspan="3" class="title"><h2>Add User</h2></td>
   <td class="vbar"><div class="clr_b"></div></td>
  </tr>
  <?php echo $hbar; ?>     
 </thead>
 <tbody>
  <tr class="data">
   ...
   <td class="vbar"><div class="clr_b"></div></td>
   <td class="data"><input type="text" size="60" name="userinfo[username]" value="<?php echo htmlentities($this->userinfo["username"]); ?>" /></td>
   <td class="vbar"><div class="clr_b"></div></td>
  </tr>
  <tr class="data">
   <td class="vbar"><div class="clr_b"></div></td>      
  ...
  <tr class="controls">
   <td colspan="5">
    <ul>
     ...
     <li><a href="#userinfo_go2"><span><input type="radio" name="task" value="register_user" /> Save</span></a></li>
     <li><a href="#userinfo_go2"><span><input type="radio" name="task" value="new_user_reset" /> Reset</span></a></li>
