...
class Tinymce_3_3_8 extends TinyMCE 
{
    ...
    public $theme_advanced_buttons = array(
    ...
    public $convert_urls = false;
    public $theme_advanced_toolbar_location = "top";
    var $theme_advanced_toolbar_align = "left";
    var $theme_advanced_statusbar_location = "bottom"; 
    var $template_external_list_url = '';
    var $external_link_list_url = '';
    var $external_image_list_url = null;
    ...
    function __construct() {
       ...
       $this->external_image_list_url =  $this->getBaseURL().'/lists/empty_image_list.js';
    }

    // end class Tinymce_3_3_8
}
