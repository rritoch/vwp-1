...
class JSDocument extends VDocument 
{
    ...
    public $_mime_type = "text/javascript";    
    //public $_mime_type = "text/plain";
    /**
     * Cache Enabled
     */
    
    public $_cache_enabled = true;
    ...
    protected function _parseDriverTags($source) 
    {
        ...
        while(preg_match($match,$t)) {    
            ...
            if ($result == null) {
                $this->setError(__CLASS__."::_parseDriverTags ended with errors!");     
                return $t;
            }
            $t = $result;        
        }
    ...
    function render() 
    {
        ...
        if ($mode == 'raw') {
            ...
            $themeTemplate = $theme_path.DS.'template.js.php';
